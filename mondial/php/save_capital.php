...
// validate the variables ======================================================
   ...
   if (!preg_match($date_regex, $today)){
        ...
        if(!$row){$errors['name'] .= 'Prêt pour cet utilisateur introuvable!';}
        else{
...
/*
  ...
  */         
		...
		$sql="INSERT INTO transactions (date, client, amount, capital, tr_operator) VALUES ('$today', '$code', 0, $amount, '$operator')";
