...
<style>
    ...
    .wrapper-transactions form#transact label{
            color: #333;
            font-size: 1.1em;
        }
    .wrapper-transactions form#transact input{
            color: #006060;
            margin-bottom: .5em;
        }
    .wrapper-transactions form#transact .row{
            margin-top: 25px;
        }
    .wrapper-transactions .paginate{
            margin: 0 auto;
            display: table;
            color: black;
        }
    .wrapper-transactions .paginate li{
            display: inline;
            margin: 5px 1px;
        }
    .wrapper-transactions .paginate li a{
...
<h3>Transactions des interets</h3>
                <div id="find_user">
    ...
    $('form#transact').submit(function(event) {
        var formData = {
            ...
            $.ajax({
                ...
                url : 'save_transact.php', // the url where we want to POST
